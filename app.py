...
from logic_utils import (
    attempts_remaining,
    check_guess as _check_outcome,
    get_range_for_difficulty,
    parse_guess,
    update_score,
)

# Hint message shown to the player for each outcome. A guess above the secret
# is "Too High", so the player must go LOWER (and vice versa).
HINT_MESSAGES = {
    "Win": "🎉 Correct!",
    "Too High": "📉 Go LOWER!",
    "Too Low": "📈 Go HIGHER!",
...
def check_guess(guess, secret):
    """Return (outcome, message) for the UI, using the shared outcome logic."""
    outcome = _check_outcome(guess, secret)
    return outcome, HINT_MESSAGES[outcome]
